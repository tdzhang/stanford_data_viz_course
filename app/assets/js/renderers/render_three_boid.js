...
Boid.prototype.update_mesh = function(){
    ...
    //var momentum = Math.sqrt( Math.pow(this.velocity.x,2) + Math.pow(this.velocity.y,2) + Math.pow(this.velocity.z,2) ) * this.radius;
...
var data = [];
for (var i = 0; i < n; i++){
    //var p = new Boid(SCENE_WIDTH, SCENE_HEIGHT);
    //p.set_parameters();
    //p.init_mesh_obj();
